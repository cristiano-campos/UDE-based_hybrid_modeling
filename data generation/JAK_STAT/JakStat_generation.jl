...
#first-principle parameters of the big model
...
folder = "conditions_yamada_$(points_per_species)pts"
...
function sample_u0(rng) 
    #d is a continuous distributions with a lower bound of 0 and upper bound of 1000
    d = Uniform(0, 1000)
    #It generates a random sample of size 34 from the uniform distribution d 
    sample = rand(rng, d, 34)
    return sample
end


selected_species = [8, 12, 27, 30, 32]
