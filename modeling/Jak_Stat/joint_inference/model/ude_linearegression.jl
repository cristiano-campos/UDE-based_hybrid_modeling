...
function ude_dynamics!(du, u, θ, nn_st, t, know_mech_p)
    ...
    k50  = :k50 in keys(θ_mech) ? θ_mech.k50 : know_mech_p.k50;
    k51  = :k51   in keys(θ_mech) ? θ_mech.k51   : know_mech_p.k51;
    k58  = :k58   in keys(θ_mech) ? θ_mech.k58   : know_mech_p.k58;
    k59  = :k59   in keys(θ_mech) ? θ_mech.k59   : know_mech_p.k59;
    k53  = :k53 in keys(θ_mech) ? θ_mech.k53 : know_mech_p.k53;
    k61  = :k61   in keys(θ_mech) ? θ_mech.k61   : know_mech_p.k61;
...
all_params = ["k50", "k51" , "k58", "k59","k53", "k61"];
default_value = [1/1000, 1/5, 1/1000, 1/5, 1/2000, 1/2000];
...
function initialize_mech_p()
    ...
    for (i, param) in enumerate(all_params)
        if infer_mask[i]
            global mech_p_to_infer_str *= "$(param)=$(abs.(rand())),";
